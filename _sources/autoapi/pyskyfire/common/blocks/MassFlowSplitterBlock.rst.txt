pyskyfire.common.blocks.MassFlowSplitterBlock
=============================================

.. py:class:: pyskyfire.common.blocks.MassFlowSplitterBlock(name: str, st_in: str, st_out: list[str], medium, fractions: list[float] | None = None, frac_keys: list[str] | None = None)

   Bases: :py:obj:`FluidBlock`

   .. autoapi-inheritance-diagram:: pyskyfire.common.blocks.MassFlowSplitterBlock
      :parts: 1
      :private-bases:

...
def main(output_dir: Path | None = None) -> None:
    ...
    tab_cooling_data.add_figure(psf.viz.PlotSaturationMargin(cooling_data))
    tab_cooling_data.add_figure(psf.viz.PlotCoolantQuality(cooling_data))
    tab_cooling_data.add_figure(psf.viz.PlotCoolantPhase(cooling_data))

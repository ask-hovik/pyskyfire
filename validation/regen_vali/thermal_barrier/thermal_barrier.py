...
copper_wall = psf.regen.Wall(material = psf.common.material.CopperC106, thickness = 0.5e-3) 
zirconia_wall = psf.regen.Wall(material = psf.common.material.ZirconiumOxide, thickness = zirconia_thickness)

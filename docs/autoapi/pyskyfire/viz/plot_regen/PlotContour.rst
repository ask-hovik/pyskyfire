...
.. py:class:: pyskyfire.viz.plot_regen.PlotContour(*contours: Any, show_labels: bool = True, title: str = 'Contour Profiles', template: str = 'plotly_white')

   Bases: :py:obj:`pyskyfire.viz.core.PlotBase`

   .. autoapi-inheritance-diagram:: pyskyfire.viz.plot_regen.PlotContour
      :parts: 1
      :private-bases:

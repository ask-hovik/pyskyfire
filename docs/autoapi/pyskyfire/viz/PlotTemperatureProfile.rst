...
.. py:class:: pyskyfire.viz.PlotTemperatureProfile(results, thrust_chamber, circuit_index: int, x_query: float, n_bl: int = 1000)

   Bases: :py:obj:`pyskyfire.viz.core.PlotBase`

   .. autoapi-inheritance-diagram:: pyskyfire.viz.PlotTemperatureProfile
      :parts: 1
      :private-bases:

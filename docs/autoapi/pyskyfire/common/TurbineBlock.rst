...
.. py:class:: pyskyfire.common.TurbineBlock(name: str, st_in: str, st_out: str, P_req_key: str, eta: float, medium: str)

   Bases: :py:obj:`FluidBlock`

   .. autoapi-inheritance-diagram:: pyskyfire.common.TurbineBlock
      :parts: 1
      :private-bases:

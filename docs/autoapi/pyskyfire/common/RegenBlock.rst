...
.. py:class:: pyskyfire.common.RegenBlock(name: str, st_in: str, st_out: str, circuit_index: int, thrust_chamber, medium)

   Bases: :py:obj:`FluidBlock`

   .. autoapi-inheritance-diagram:: pyskyfire.common.RegenBlock
      :parts: 1
      :private-bases:

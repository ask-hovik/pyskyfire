...
.. py:class:: pyskyfire.regen.thrust_chamber.InternalPlacement(n_channel_positions: int, n_channels_per_leaf: int, *, channel_width, occludes: bool = False)

   Bases: :py:obj:`ChannelPlacement`

   .. autoapi-inheritance-diagram:: pyskyfire.regen.thrust_chamber.InternalPlacement
      :parts: 1
      :private-bases:

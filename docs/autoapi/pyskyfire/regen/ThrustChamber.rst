...
.. py:class:: pyskyfire.regen.ThrustChamber(contour, wall_group, cooling_circuit_group, combustion_transport, optimal_values=None, roughness=1.5e-05, K_factor=0.3, n_nodes=50, h_gas_corr=1.0, h_cold_corr=1.0)
